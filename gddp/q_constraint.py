...
class QConstraint(object):
    ...
    def xi_1(self, x_plus_initial_guess, x_dependent=False, value_to_beat=None):
    ...
    def xi_2(self, x, pi, lambda_c, lambda_b):
        """Evaluate xi_2 in closed analytic form for the case where input cost Hessian R > 0."""
    ...
    def eval_at(self, x_in, u_in, exclude_zeta_1=False):
    ...
    def plot_function(self, output_dir, iter_no):
        ...
        if self.n == 1 and self.m == 1:
            ...
            for ind1, x_plot in enumerate(x1):
                for ind2, u_plot in enumerate(x2):
